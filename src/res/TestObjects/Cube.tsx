...
const vertexBuffer: VertexBuffer = new VertexBuffer(
	new Float32Array([
		1, 1, 1, 0.86, 0.45, 0.25, 1,

		1, 1, -1, 0.86, 0.86, 0.25, 1,

		1, -1, 1, 0.25, 0.86, 0.25, 1,

		1, -1, -1, 0.45, 0.86, 0.86, 1,

		-1, 1, 1, 0.25, 0.25, 0.86, 1,

		-1, 1, -1, 0.86, 0.45, 0.86, 1,

		-1, -1, 1, 0.45, 0.25, 0.45, 1,

		-1, -1, -1, 0.86, 0.86, 0.86, 1,
	]),
...
const fragmentShader: Shader = new Shader(
	...
	void main(void) {
		...
		gl_FragColor = vasdfasdfasdfasdfa;
	}
	`,
	ShaderType.FRAGMENT
);
